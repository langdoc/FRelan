...
read_eaf <- function(path = ".", pattern = "\\.eaf$", tokenization = TRUE, ind.tier = "refT", ind.tier2 = FALSE, SA.tier = "orthT", SS.tier = "wordT", ft.tier = FALSE, ignore = FALSE, recursive = FALSE, part = FALSE){
